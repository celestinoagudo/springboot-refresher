...
public class ApplicationUser implements UserDetails {
  ...
  public boolean equals(final Object object) {
    ...
    return Objects.equals(getUserAccount().getPassword(), other.getUserAccount().getPassword())
        && Objects.equals(getUserAccount().getUsername(), other.getUserAccount().getUsername());
  }
  ...
  public String toString() {
    return "ApplicationUser{grantedAuthorities=%s, userAccount=%s}"
        .formatted(grantedAuthorities, userAccount);
  }
