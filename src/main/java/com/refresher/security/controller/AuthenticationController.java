...
public class AuthenticationController {
  ...
  @Operation(
      ...
      description =
          "Register an application user. Allowable roles are: ADMIN, ADMIN_TRAINEE and STUDENT",
  ...
  @Operation(
      ...
      description =
          "Authenticates an application user. Returns JWT which will be used as mode of authentication.",
      tags = {"application-user", "security", "post"})
  @ApiResponses(
      value = {
        @ApiResponse(
