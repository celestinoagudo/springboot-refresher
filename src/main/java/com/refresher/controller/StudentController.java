...
public class StudentController {
    ...
    @Operation(
            ...
            description = "Gets students where pagination is implemented through the use of page-number and number of" +
    ...
    @PreAuthorize("hasAnyRole(@environment.getProperty('app.role.student'), "
    ...
    @Operation(
            ...
            description = "Retrieve all students. User should have appropriate role(s) when accessing this resource",
            tags = { "students", "get" })
    @ApiResponses(
            value={
                    @ApiResponse(responseCode = "200", content = {
    ...
    @Operation(
            ...
            description = "Retrieve all students where the first name or last name matches the parameter. User should " +
