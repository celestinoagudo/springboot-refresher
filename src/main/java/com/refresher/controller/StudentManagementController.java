...
public class StudentManagementController {
    ...
    public StudentManagementController(
            final StudentService studentService, final ApplicationResponseMapper applicationResponseMapper) {
    ...
    @Operation(
            ...
            description = "Add books associated to the student id parameter passed. User should have student:write" +
    ...
    @Operation(
            ...
            description = "Add student record to the database. User should have student:write authority to perform " +
                    "this operation",
            tags = { "students", "post" })
    @ApiResponses(
            value={
    ...
    @PostMapping
    @PreAuthorize("hasAuthority(@environment.getProperty('app.authority.student-write'))")
    public ResponseEntity<ApplicationResponse> addOrUpdateStudent(@RequestBody final StudentDto student) {
        var applicationResponse = applicationResponseMapper.getApplicationResponse(
    ...
    @Operation(
            ...
            description = "Enroll student to a course. The course used should be recognized and the user should have" +
    ...
    @Operation(
            ...
            description = "Gets student by the id parameter passed. User should have admin/admin_trainee role to" +
    ...
    @GetMapping(path = "/{id}")
    @PreAuthorize("hasAnyRole(@environment.getProperty('app.role.admin'), "
    ...
    @Operation(
            ...
            description = "Delete the student associated to the id parameter passed. User should have student:write " +
                    "authority to perform this operation",
    ...
    @PreAuthorize("hasAuthority(@environment.getProperty('app.authority.student-write'))")
    public ResponseEntity<ApplicationResponse> removeStudent(@PathVariable("studentId") final Long studentId) {
        var applicationResponse = applicationResponseMapper.getApplicationResponse(
